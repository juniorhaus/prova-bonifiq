...
namespace ProvaPub.Controllers
{
    ...
    public class Parte2Controller : ControllerBase
    {
        ...
        [HttpGet("products")]
        public BaseDto<Product> ListProducts(int page)
        {
            return _productService.ListProducts(page, _ctx);
        }

        [HttpGet("customers")]
        public BaseDto<Customer> ListCustomers(int page)
        {
            return _customerService.ListCustomers(page, _ctx);
        }
    }
}
